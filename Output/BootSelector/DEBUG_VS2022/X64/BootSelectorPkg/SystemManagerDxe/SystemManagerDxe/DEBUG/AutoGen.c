...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0E49055D, 0x3B02, 0x46D4, {0xB3, 0xA2, 0xDC, 0x9C, 0x79, 0x4A, 0xE4, 0x1C}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0x945A6F8E, 0xADCE, 0x407B, {0x90, 0x7D, 0xF6, 0xFD, 0x67, 0xF5, 0x6E, 0x82}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BootSelector";
...
{
  return SystemManagementEntry (ImageHandle, SystemTable);
}
